...
export class NftCollection__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class NftCollection extends ethereum.SmartContract {
  ...
  eip712Domain(): NftCollection__eip712DomainResult {
    ...
    return new NftCollection__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<NftCollection__eip712DomainResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NftCollection__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  mintedCount(): BigInt {
    let result = super.call("mintedCount", "mintedCount():(uint256)", []);

    return result[0].toBigInt();
  }

  try_mintedCount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mintedCount", "mintedCount():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
